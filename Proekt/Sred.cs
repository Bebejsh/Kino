...
namespace Proekt
{
    public partial class Sred : Form
    {
        ...
        public Sred()
        {
            ...
            C1.Text = "450";
            C2.Text = "450";
            C3.Text = "450"; C4.Text = "450";
            C21.Text = "550";
            C22.Text = "550";
            C23.Text = "550"; C24.Text = "550";
            C31.Text = "550";
            C32.Text = "550";
            C33.Text = "550"; C34.Text = "550";
            C41.Text = "450";
            C42.Text = "450";
            C43.Text = "450"; C44.Text = "450";
        }
        

        private void Sred_Load(object sender, EventArgs e)
        {
            int idDataF = IdDataF;
